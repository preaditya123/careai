...
const FeatureCard = ({ title, description, icon, iconColor, to }: FeatureCardProps) => {
  return (
    <div className="feature-card group h-full flex flex-col items-center">
      <div className={cn("feature-icon group-hover:animate-float", iconColor)}>
        {icon}
      </div>
      ...
      <Button 
        variant="outline" 
        asChild 
        className="mt-auto w-full sm:w-auto border-primary/40 hover:bg-primary hover:text-white transition-colors duration-300"
      >
